                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <button class="btn btn-sm btn-primary "
                                            data-toggle="tooltip" data-title="Mark as Document Received" data-original-title="" title="" 
                                            data-name="{{ $item->TrackingHashId()  }}"                                             
                                            data-url="{{ route('adminso.submit', ['id'=> $item->id])}}" 
...
@section('modal')
    @component('components.dialog.modal')
        <p>You are about to mark the document as RECEIVED:</p>
